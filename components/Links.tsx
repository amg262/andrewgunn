 ...
 * Magnetic links.
 *
 * Each chip leans toward the cursor as it comes within reach and carries a gold
 * spotlight that tracks the cursor across its own surface. The lean is a spring
 * toward a target offset rather than a direct mapping, so a fast pass leaves
 * them swaying instead of snapping.
 *
